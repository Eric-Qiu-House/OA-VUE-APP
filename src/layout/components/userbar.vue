	...
	<div class="user-bar">
		...
		<el-dropdown class="user panel-item" trigger="click" @command="handleUser">
			<div class="user-avatar">
				...
				<el-avatar :size="30" :src="userNameF ? userNameF : ''"
					:style="{ backgroundColor: userNameF ? '' : '#409EFF', color: '#fff' }">
					<template #default>
						<!-- 如果 avatar_ 为空，显示 fullname_ 的后两位字符 -->
						<span v-if="!userNameF" style="writing-mode: horizontal-tb;">
							{{ userName.slice(-2) }}
						</span>
					</template>
				</el-avatar>
...
export default {
	...
	data() {
		return {
			...
			msgList: [
				...
				// 	link: "https://github.com/shenxgan/scui",
				// 	time: "5分钟前"
				// },
				// {
				// 	id: 2,
	...
	created() {
		...
		this.userName = userInfo.fullname_;
		this.userNameF = this.userName.avatar_;
	},
	methods: {
		//个人信息
		handleUser(command) {
