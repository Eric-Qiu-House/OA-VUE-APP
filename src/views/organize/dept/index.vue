	...
	<el-container>
		...
		<el-main class="nopadding">
			<scTable ref="table" :data="data" row-key="id" @selection-change="selectionChange" hidePagination>
				...
				<el-table-column label="状态" prop="state_" width="150">
					<template #default="scope">
						<el-tag v-if="scope.row.state_ == 1" type="success">启用</el-tag>
						<el-tag v-if="scope.row.state_ == 0" type="danger">停用</el-tag>
					</template>
				</el-table-column>
				<el-table-column label="创建时间" prop="create_time_" width="180"></el-table-column>
				<el-table-column label="备注" prop="desc_" min-width="300"></el-table-column>
