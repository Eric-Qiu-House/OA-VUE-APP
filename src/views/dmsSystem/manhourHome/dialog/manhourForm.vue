<template>
    <el-row :gutter="40">
      ...
      <el-date-picker 
        v-model="manhoursFrom.record_date_" 
        type="date" 
      ...
      />
                ...
                <el-form-item label="审批状态">
                    <el-select v-model="manhoursFrom.ratify_type_" placeholder="请选择审批状态">
                        <el-option label="未审批" value="0" :style="{ color: 'gray' }"></el-option>
